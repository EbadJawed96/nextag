...
function showSuccessAlert() {
    ...
    alert.classList.add("show"); // Show the alert by adding the 'show' class

    // After 5 seconds, hide the alert
    setTimeout(() => {
        alert.classList.remove("show"); // Hide the alert by removing the 'show' class
    }, 5000); // Alert stays visible for 5 seconds
}

// Add this to your form submission or after the message is sent
document.getElementById('contact-form').addEventListener('submit', function (e) {
    e.preventDefault(); // Prevent form submission to simulate success
    showSuccessAlert(); // Show the success alert when the form is submitted
});
